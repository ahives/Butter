namespace Butter.Tests
{
    ...
    public class SortFieldListTests
    {
        ...
        public void Verify_can_sort()
        {
            ...
            fields.Add<Primitive>(x => x.Id("field4").Index(4).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Struct>(x => x.Id("field7")
                ...
                .Build());
            fields.Add<Primitive>(x => x.Id("field1").Index(1).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Decimal>(x => x.Id("field6").Index(6).Precision(2).Scale(5).IsNullable().Build());
            fields.Add<Primitive>(x => x.Id("field2").Index(2).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Primitive>(x => x.Id("field5").Index(5).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Primitive>(x => x.Id("field3").Index(3).DataType(SchemaDataType.Primitive).IsNullable().Build());
            ...
            Assert.AreEqual(SchemaDataType.Struct, fields[1].DataType);
            Assert.AreEqual(SchemaDataType.Decimal, fields[3].DataType);
            ...
            Assert.AreEqual(SchemaDataType.Struct, fields[6].DataType);
            Assert.AreEqual(SchemaDataType.Decimal, fields[5].DataType);
        }
        ...
        public void Verify_can_sort_when_indexes_are_same()
        {
            ...
            fields.Add<Primitive>(x => x.Id("field4").Index(3).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Struct>(x => x.Id("field7")
                .Index(6)
                .Field<Primitive>(f => f.Id("fieldA").DataType(SchemaDataType.Primitive).IsNullable().Build())
                .Field<Primitive>(f => f.Id("fieldB").DataType(SchemaDataType.Primitive).IsNullable().Build())
            ...
            fields.Add<Primitive>(x => x.Id("field2").Index(2).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Primitive>(x => x.Id("field5").Index(4).DataType(SchemaDataType.Primitive).IsNullable().Build());
            fields.Add<Primitive>(x => x.Id("field3").Index(3).DataType(SchemaDataType.Primitive).IsNullable().Build());
